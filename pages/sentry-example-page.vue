...
<template>
  <div>
    <main>
      ...
      <p class="description">
        Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://kirillov.sentry.io/issues/?project=4510487831052288">Issues Page</a>.
