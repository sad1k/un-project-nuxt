...
<template>
  <ClientOnly>
    ...
    >
      <div
        class="group/file relative block w-full cursor-pointer overflow-hidden rounded-lg"
        @click="handleClick"
      >
        <input
          ref="fileInputRef"
        ...
        <div class="flex flex-col items-center justify-center">
          ...
          <p
            class="relative z-20 mt-2 font-sans text-base text-center font-normal text-neutral-400 dark:text-neutral-400"
          >
